...
void UKF::ProcessMeasurement(MeasurementPackage meas_package)
{
  ...
  */
  ...
  float delta_t = (meas_package.timestamp_ - previous_timestamp_) / 1000000.0; // convert to seconds
...
void UKF::PredictMeasurementRadar(MatrixXd *Zsig_pred, VectorXd *z_pred, MatrixXd *S_pred)
{
...
void UKF::InnovateRadar(VectorXd raw_measurements, MatrixXd Zsig_pred, VectorXd z_pred, MatrixXd S_pred)
{
